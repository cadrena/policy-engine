...
const (
	// DriverName is intentionally distinct from modernc.org/sqlite's "sqlite"
	// registration so a policy-engine consumer may import both packages.
	DriverName              = "cadrena-sqlite-nofollow"
